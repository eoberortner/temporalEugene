package org.cidarlab.minieugene.interpreter;
...
public class MiniEugeneInterpreter {
	
	private SymbolTables symbols;
	private PredicateBuilder pb;
	private int N;
	
	public MiniEugeneInterpreter(SymbolTables symbols) {
	...
	private Predicate createBinaryPredicate(String a, String X, String b) 
		...
		if("NOT".equalsIgnoreCase(a)) {
			 ...
			 * e.g. NOT CONTAINS a
			 */
			return this.pb.buildNegatedUnary(X, this.symbols.get(this.symbols.getId(b)));
